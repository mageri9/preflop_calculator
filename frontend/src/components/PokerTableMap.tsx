...
// Сетка координат по часовой стрелке (Bottom -> Left -> Top -> Right)
const SEAT_LAYOUTS: Record<number, Array<{ left: number; top: number }>> = {
  9: [
    { left: 50, top: 90 }, // 0: Hero (Снизу по центру)
    { left: 12, top: 83 }, // 1: Столбик слева - нижний угол (7 часов)
    { left: 8, top: 50 },  // 2: Столбик слева - центр (9 часов)
    { left: 12, top: 17 }, // 3: Столбик слева - верхний угол (11 часов)
    { left: 37, top: 10 }, // 4: Вверху слева (11:30)
    { left: 63, top: 10 }, // 5: Вверху справа (12:30)
    { left: 88, top: 17 }, // 6: Столбик справа - верхний угол (1 час)
    { left: 92, top: 50 }, // 7: Столбик справа - центр (3 часа)
    { left: 88, top: 83 }, // 8: Столбик справа - нижний угол (5 часов)
  ],
  8: [
    { left: 50, top: 90 }, // 0: Hero
    { left: 12, top: 83 }, // 1: Столбик слева - нижний угол
    { left: 8, top: 50 },  // 2: Столбик слева - центр
    { left: 12, top: 17 }, // 3: Столбик слева - верхний угол
    { left: 50, top: 10 }, // 4: Вверху по центру
    { left: 88, top: 17 }, // 5: Столбик справа - верхний угол
    { left: 92, top: 50 }, // 6: Столбик справа - центр
    { left: 88, top: 83 }, // 7: Столбик справа - нижний угол
  ],
  7: [
    { left: 50, top: 90 },
    { left: 12, top: 81 },
